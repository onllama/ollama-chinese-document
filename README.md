...
[手动安装](https://github.com/ollama/ollama/blob/main/docs/linux.md)

### Docker

官方的 Ollama 的 [Docker 镜像](https://hub.docker.com/r/ollama/ollama) `ollama/ollama` 可在 Docker Hub 上获取。
...
Ollama支持的模型列表可以在 [ollama.com/library](https://ollama.com/library "ollama model library") 查看
...
有关详细信息，请参阅有关导入模型的 [指南](https://github.com/ollama/ollama/blob/main/docs/import.md)。
...
更多信息请参阅 [开发者指南](https://github.com/ollama/ollama/blob/main/docs/development.md)
...
- Ollama 由 Georgi Gerganov 所创建的项目 [llama.cpp](https://github.com/ggerganov/llama.cpp) 强力驱动。
